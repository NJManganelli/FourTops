...
void DatasetPlotter(int nBins, float lScale, float plotLow, float plotHigh, string leptoAbbr, TFile *shapefile, TFile *errorfile, string channel, string sVarofinterest, string xmlNom, string CraneenPath, string shapefileName)
{
	...
	if(leptoAbbr.find("Combined")!=string::npos)
	{
	    ...
	    {
		filepath = CraneenPath+"TTDileptMG_TopPt_Run2_TopTree_Study.root";        //cout<<"filepath: "<<filepath<<endl;
	    }
	    ...
	    {
		filepath = CraneenPath+"NP_overlay_ttttNLO_Run2_TopTree_Study.root";        //cout<<"filepath: "<<filepath<<endl;
	    }
	}
        else filepath = CraneenPath+dataSetName + "_Run2_TopTree_Study.root";        //cout<<"filepath: "<<filepath<<endl;
	...
	if(leptoAbbr.find("Combined")!=string::npos)
	{
        ...
        else nTuplename = "Craneen__"+ leptoAbbr;
    ...
    for(map<string,MultiSamplePlot*>::const_iterator it = MSPlot.begin(); it != MSPlot.end(); it++)
    {
        ...
        temp->Draw(sVarofinterest.c_str(), 1, false, true, false, 100);
...
void CutFlowPlotter(TFile *cffile, string leptoAbbr, string channel, string xmlNom, string CraneenPath, int nCuts, float lScale)
{
    ...
    cout<<"unloading datasets"<<endl;
        ...
        cutFlowPlot->Draw("Cut Flow", 1, false, true, false, 100);
